...
### Fastget
Standalone order fulfillment system. See `/Users/vamshi.chirumavilla/fastget/TODOS.md` for Fastget-specific roadmap.

**Note:** Fastget is now a separate project in `~/fastget/`. It uses gstack skills but maintains its own backlog.
